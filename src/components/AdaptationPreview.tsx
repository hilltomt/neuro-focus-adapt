      ...
      <div className="container mx-auto px-6">
        ...
        >
          ...
          <Card className="p-6 bg-card border-border rounded-xl">
            <div className="text-xs font-bold font-display text-muted-foreground uppercase tracking-widest mb-5">
              Before Neuro
            </div>
            <div className="space-y-4">
              {comparisons.map((item, i) => (
                <div key={i} className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-foreground leading-relaxed font-body">{item.before}</p>
                </div>
              ))}
            </div>
          </Card>
          ...
          <Card className="p-6 bg-primary/5 border-primary/20 rounded-xl">
            <div className="text-xs font-bold font-display text-primary uppercase tracking-widest mb-5">
              With Neuro
            </div>
            <div className="space-y-4">
              {comparisons.map((item, i) => (
                <div key={i} className="flex items-start gap-3">
                  ...
                  <p className="text-sm text-foreground leading-relaxed font-body">{item.after}</p>
                </div>
              ))}
            </div>
          </Card>
